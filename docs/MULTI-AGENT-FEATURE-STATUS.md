...
| 3 | **PRT-214 G1** | 项目主 | Legion host-plane 是否冻结（不再加新的 host 插件） | per-Run 授权身份只能做到"进程级"，多空间时错标 ★★★ 2026-09-24 业主裁定（本会话）：**Legion host-plane 冻结** —— 不再新增 host 插件，新能力走补丁层 / preset ⇒ **已裁决**。 |
