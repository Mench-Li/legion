...
| 28 | 那条"出站车道"的文件该放在哪个目录 | 已裁决 | 产品 + 架构（★ 2026-09-24 业主裁定 **丙**：按 Run 交付目录（PRT-214 五性质），runId 在**按 Run 安装**那一处绑、**不**在 `root-row.mjs:591` 那个进程级单例上绑；★ **接线尚未开始**） |
| 29 | RunRequest.env | 已裁决 | 产品 + 架构 |

⇒ **合计**：已裁决 **15** · 待施工 **0** · 待裁决 **0** · **未标注 14**（共 29 行）。
> ★ **2026-09-24 业主对第 18 / 28 条一并裁定**（丙 + 同族一次裁完）⇒ 13/0/2/14 → **15/0/0/14**。
> ⚠️ **被取代的陈述**：本节旧文里"**位置未决**""**本轮不替业主选**""**待裁决**"这三处说法读的是**裁定之前**的状态；
