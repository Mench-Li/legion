...
| 族 | 代表模块 | 已在 §5 的哪一条 |
| --- | --- | --- |
| **生命周期 / 阶段 9 产品动作** | `product/lifecycle/{data-export,retention,uninstall}.mjs`（★ `data-classes.mjs` **已清**：第 118 轮第十四轮**连带**接上——`privacy.mjs` import 它，而 `privacy.mjs` 是 `--report=privacy` 的生产 importer） | 第 16 条 |
