...
**最近一次全量基线**：2026-09-12　`run-ci --only test` **PASS**；其中 `test` **98 套件 / 2434 用例**
（**须设 `DSH_CHECKOUT`**：不设时 `plugins/board-plugin` 与 `plugins` 按纪律 SKIP，计数为 97 套件 / 2401 用例）
—— 以本文件所在提交为准；证据 `.ci/2026-09-12T08-12-42-130Z/`
