...
import {
  ...
  sampleElement,
  deserializeDoc,
} from 'file:///D:/project/DSH/legion/.legion-worktrees/T-042/whiteboard/packages/shared/src/index.mjs';

const __dirname = path.dirname(fileURLToPath(import.meta.url));
const SERVER = path.resolve(__dirname, 'D:/project/DSH/legion/.legion-worktrees/T-042/whiteboard/apps/server/src/index.js');
